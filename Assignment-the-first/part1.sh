...
#SBATCH --error=part1_%j.err        #optional: file to store stderr from job, %j adds the assigned jobID


mamba activate bgmp_demultiplex

# /usr/bin/time ./part1.py -f "/projects/bgmp/shared/2017_sequencing/1294_S1_L008_R1_001.fastq.gz" -l 101

# /usr/bin/time ./part1.py -f "/projects/bgmp/shared/2017_sequencing/1294_S1_L008_R2_001.fastq.gz" -l 8
